            ...
            <div class="ml-10 flex items-baseline space-x-4">
             <Link to="/swipe"
              className={
                ...
                "bg-gray-900" : "text-white px-3 py-2 rounded-md text-sm font-medium"}>Explore</Link>
                  <Link to="/profile"
              className={
                window.location.pathname === "/profile" ?
                "bg-gray-900" : "text-white px-3 py-2 rounded-md text-sm font-medium"}>Profile</Link>
                  <Link to="/matches"
              className={
                window.location.pathname === "/matches" ?
                "bg-gray-900" : "text-white px-3 py-2 rounded-md text-sm font-medium"}>Matches</Link>
